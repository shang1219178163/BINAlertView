...
//            NSLog(@"字典中key=%@的值是int类型,值为%ld",key,[value integerValue]);
            return [@([value integerValue]) stringValue];
        }
        
        if (strcmp(pObjCType, @encode(unsigned int))  == 0) {
//            NSLog(@"字典中key=%@的值是int类型,值为%d",key,[value unsignedIntValue]);
...
//            NSLog(@"字典中key=%@的值是float类型,值为%f",key,valueFloat);
...
//            NSLog(@"字典中key=%@的值是double类型,值为%f",key,valueDouble);
...
//            NSLog(@"字典中key=%@的值是double类型,值为%ld",key,valueLong);
            return valueLongStr;
...
//            NSLog(@"字典中key=%@的值是double类型,值为%lld",key,valueLongLong);
...
//            NSLog(@"字典中key=%@的值是double类型,值为%ld",key,valueLongU);
...
//            NSLog(@"字典中key=%@的值是double类型,值为%llu",key,valueLongLongU);
